...
--retrieve the employee’s first and last name and the first and last name of his or her immediate supervisor--
SELECT E.Fname as employ, E.Lname, S.Fname as supervisor, S.Lname FROM EMPLOYEE AS E, EMPLOYEE AS S WHERE E.Superssn=S.Ssn; 

--aliasing--
select  fname as fn, minit as Mi, lname as Ln, ssn as Ssn
from EMPLOYEE as E ;
--cartesan product--
...
select fname, minit,lname from EMPLOYEE where dno=6;
--any--
select fname
from employee as e
where e.dno = any (select dnumber from department where mgrstartdate > '1997-02-01'); 
--all--
select fname
from employee as e
where e.dno = all (select dnumber from department where mgrstartdate > '1997-02-01'); 

select * from employee  WHERE Ssn LIKE '%1100';
select 1.1*salary as increaasedSalary from EMPLOYEE;

--new table from existing--
SELECT *
INTO D5EMPS
FROM EMPLOYEE as E
WHERE E.Dno=5;
